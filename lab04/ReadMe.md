...
Считаем, что Москва, Санкт-Петербург, Чокурдах, Лабытнанги --- отделения компании, а Киторн, Ламас, Триада --- провайдеры.
...
Приведённый IP-план обеспечивает разделение IP-пространства между разными сущностями, гибкость и масштабируемось.
