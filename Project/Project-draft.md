...
## Оглавление
1. [Протоколы L2/L3 (внутри региона)](#Протоколы-L2/L3-(внутри-региона))
    ...
    1.9. [](#)
3. [Задачи](#задачи)
4. [Сетевая топология](#Сетевая-топология)
5. [План IP адресации](#План-IP-адресации)
6. [Конфигурация оборудования](#Конфигурация-оборудования)
7. [Диагностика оборудования](#Диагностика-оборудования)
