...
Ранее автор не имел опыта настройки оборудования H3C. 
...
Транспортная сеть ссотоит из четырёх маршрутизаторов.
...
VPC1-1>
```   
Меняю vrrp priority на значение 200 на коммутаторе DSW1-1, на DSW1-2 ставлю в значение 100:
...
Туннели будем поднимать на "Loopback-ах", для данного функционала добавлю Loopback-интерфейсы на маршрутизаторах R1-1 м R2-1 согласно следующей таблицы:
